...
export declare const getCurrentComponent: (hookName: string) => ComponentContext;
...
export declare const createComponent: (wrap: IComponent) => (root: RefElement, props: Record<string, any>) => ComponentContext;
