...
var $ = (t, n, e) =>
  n in t ? D(t, n, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (t[n] = e)
var u = (t, n, e) => ($(t, typeof n != 'symbol' ? n + '' : n, e), e),
  C = (t, n, e) => {
    if (!n.has(t)) throw TypeError('Cannot ' + e)
  }
var i = (t, n, e) => (C(t, n, 'read from private field'), e ? e.call(t) : n.get(t)),
  f = (t, n, e) => {
...
const j = t => new A(t)
function O(t, n) {
  if (!t) throw new Error(n || 'unexpected condition')
}
...
let p
const x = t => (p = t),
  M = t => (O(p, `"${t}" called outside setup() will never be run.`), p)
let y = 0
var k, L, a
class S {
  constructor(n) {
    ...
    u(this, 'current', {})
    u(this, 'mount', () => {
      N([...this[l.MOUNTED], ...i(this, a).flatMap(n => n.mount)])
    })
    u(this, 'unmount', () => {
      N([...this[l.UNMOUNTED], ...i(this, a).flatMap(n => n.unmount)])
    })
    u(this, 'addChild', n => {
    ...
    u(this, 'removeChild', n => {
      ...
      n.unmount(), e !== -1 && (i(this, a).splice(e, 1), (n.parent = null))
    })
    ;(this.element = n), (this.uid = y++)
  }
}
...
const G = (
    ...
    return (
      Array.isArray(t) ? t.forEach(r => o.observe(r)) : o.observe(t),
      E(() => {
        o.disconnect()
      }),
      {
